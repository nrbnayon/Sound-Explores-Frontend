...
const FriendRequests = ({ receivedRequests, sentRequests, isLoading }) => {
  ...
  const handleInitiateAction = (action, userId) => {
    // Find the request in the appropriate list
    const request =
      action === "reject"
        ? receivedRequests.find((req) => req._id === userId)
        : sentRequests.find((req) => req._id === userId);
                    ...
                    <div className="flex-shrink-0 mr-3">
                      ...
                      >
                        <img
                          ...
                          alt={request.firstName || request.email}
                ...
                <p className="text-gray-600">
                  {modalAction === "reject"
                    ? `Are you sure you want to reject the friend request from ${
                        requestToAction?.firstName ||
                        requestToAction?.email ||
                        "this user"
                      }?`
